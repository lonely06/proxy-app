...
- `sub-store/pokemon-rotate.js`: keep Pokemon accounts serial; filter `[PKM1]` / `[PKM2]` / `[PKM3]` to the current account; switch only when exhausted; do not merge this into `flow-alert.js`; do not put device keys in the repo.
